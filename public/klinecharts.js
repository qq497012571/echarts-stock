...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function logTag() {
        log('%c❤️ Welcome to klinecharts. Version is 9.1.0', 'border-radius:2px;border:dashed 1px #1677FF;padding:26px 20px;margin:16px 0;font-size:14px;color:#1677FF', '', '', '');
    }
    ...
    var DrawWidget = /** @class */ (function (_super) {
        ...
        DrawWidget.prototype._optimalUpdateMain = function () {
            var _this = this;
        ...
        DrawWidget.prototype._optimalUpdateOverlay = function () {
            var _this = this;
        ...
        DrawWidget.prototype.updateImp = function (level, container, bounding) {
            ...
            var sizeFlag = width !== container.offsetWidth || height !== container.offsetHeight;
            var l = level;
            if (sizeFlag) {
                ...
                var domWidth = "".concat(width, "px");
                var domHeight = "".concat(height, "px");
                container.style.width = domWidth;
                container.style.height = domHeight;
                var pixelRatio = getPixelRatio(this._mainCanvas);
     ...
     */
    var figures = {};
    var extensions = [circle, line, polygon, rect, text, rectText];
    ...
    var IndicatorTooltipView = /** @class */ (function (_super) {
        ...
        function IndicatorTooltipView() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this._boundIconClickEvent = function (currentIconInfo, iconId) {
                return function () {
                        ...
                        if (this._startScrollCoordinate !== null) {
                            ...
                            if (time < 200 && Math.abs(v_1) > 0) {
                                ...
                                var flingScroll_1 = function () {
                                    _this._flingScrollTimerId = setTimeout(function () {
                                        timeScaleStore_1.startScroll();
                                        timeScaleStore_1.scroll(v_1);
                                        v_1 = v_1 * (1 - 0.025);
                                        if (Math.abs(v_1) < 1) {
                                            if (_this._flingScrollTimerId !== null) {
                                                clearTimeout(_this._flingScrollTimerId);
                                                _this._flingScrollTimerId = null;
                                            }
                                        }
                                        else {
                                            flingScroll_1();
